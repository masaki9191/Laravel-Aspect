    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form" name="form" action="{{route('build.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control  @error('scale') is-invalid @enderror"  id="scale" name="scale" value="{{ old('scale') }}">
                                @error('scale')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control  @error('construction') is-invalid @enderror"  id="construction" name="construction" value="{{ old('construction') }}">
                                @error('construction')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control  @error('room') is-invalid @enderror"  id="room" name="room" value="{{ old('room') }}">
                                @error('room')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control  @error('total_area') is-invalid @enderror"  id="total_area" name="total_area" value="{{ old('total_area') }}">
                                @error('total_area')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control  @error('rent_area_from') is-invalid @enderror"  id="rent_area_from" name="rent_area_from" value="{{ old('rent_area_from') }}">
                                @error('rent_area_from')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                                @enderror
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control  @error('rent_area_to') is-invalid @enderror"  id="rent_area_to" name="rent_area_to" value="{{ old('rent_area_to') }}">
                                @error('rent_area_to')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="date" class="form-control  @error('completion') is-invalid @enderror"  id="completion" name="completion" value="{{ old('completion') }}">
                                @error('completion')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img id="main_photo_output" name="main_photo_output" src="" class="p-1" style="border: 1px solid rgba(0,0,0,0.12);width:100%"/>
                                @error('main_photo')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
