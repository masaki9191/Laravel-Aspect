    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form" name="form" action="{{route('room.update', $room->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                @foreach($builds as $key => $value)
                                    <option value="{{$value['id']}}" {{ $value['id'] == $room->build_id ? "selected" : "" }}>{{$value['name']}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control  @error('no') is-invalid @enderror"  id="no" name="no" value="{{ old('no') ?? $room->no }}">
                                @error('no')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control  @error('rent_size') is-invalid @enderror"  id="rent_size" name="rent_size" value="{{ old('rent_size') ?? $room->rent_size }}">
                                @error('rent_size')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control  @error('area') is-invalid @enderror"  id="area" name="area" value="{{ old('area') ?? $room->area }}">
                                @error('area')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control  @error('facility') is-invalid @enderror"  id="facility" name="facility" >{{ old('facility') ?? $room->facility }}</textarea>
                                @error('facility')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control  @error('point') is-invalid @enderror"  id="point" name="point" >{{ old('point') ?? $room->point }}</textarea>
                                @error('point')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img id="design_photo_output" name="design_photo_output" src="{{ $room->photo('design_photo') != null? $room->photo('design_photo')->getUrl() : '' }}" class="p-1" style="border: 1px solid rgba(0,0,0,0.12);width:100%"/>
                                @error('design_photo')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
